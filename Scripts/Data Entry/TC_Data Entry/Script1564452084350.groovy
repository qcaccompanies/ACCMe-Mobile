...
not_run: WebUI.callTestCase(findTestCase('Data Entry/Borrower/Flow Borrower'), [('BvarPekerjaanTab') : BvarPekerjaanTab, ('BvarUsahaTab') : BvarUsahaTab
        ...
        , ('BIvarMasaBerlaku') : BIvarMasaBerlaku, ('BIvarJenisKelamin') : BIvarJenisKelamin, ('BIvarVerifikasi') : BIvarVerifikasi
        ...
        , ('BIUvarSumberDanaAngsuran') : BIUvarSumberDanaAngsuran, ('BIUvarKepemilikanDana') : BIUvarKepemilikanDana, ('BIUvarAlamatMenyurat') : BDvarNegaraDomisili
        ...
        , ('BDvarTelponSelular') : BDvarTelponSelular, ('BDvarDomisili') : BDvarDomisili, ('BDvarROAO') : BDvarROAO, ('BPvarPekerjaan') : BPvarPekerjaan
        , ('BPvarJabatan') : BPvarJabatan, ('BPvarDepartemen') : BPvarDepartemen, ('BPvarStatusKaryawan') : BPvarStatusKaryawan
...
not_run: if (AllStatusPerkawinan == 'Married') {
    ...
    WebUI.callTestCase(findTestCase('Data Entry/Co-Borrower/Flow Coborrower'), [('CvarPekerjaanTab') : CvarPekerjaanTab, ('CvarUsahaTab') : CvarUsahaTab
            ...
            , ('CIvarKewarganegaraan') : CIvarKewarganegaraan, ('CIvarMasaBerlaku') : CIvarMasaBerlaku, ('CIvarVerifikasi') : CIvarVerifikasi
            , ('CIUvarNamaLengkap') : CIUvarNamaLengkap, ('CIUvarNPWP') : CIUvarNPWP, ('CIUvarNamaNPWP') : CIUvarNamaNPWP
            , ('CIUvarNamaIbu') : CIUvarNamaIbu, ('CIUvarPendidikan') : CIUvarPendidikan, ('CIUvarAlamatEmail') : CIUvarAlamatEmail
            , ('CIUvarNoTlp1') : CIUvarNoTlp1, ('CIUvarNoTlp2') : CIUvarNoTlp2, ('CIUvarHP') : CIUvarHP, ('CIUvarJenisAkunSosmed') : CIUvarJenisAkunSosmed
            , ('CIUvarAkunSosmed') : CIUvarAkunSosmed, ('CDvarAlamatLengkap') : CDvarAlamatLengkap, ('CDvarRT') : CDvarRT
            , ('CDvarRW') : CDvarRW, ('CDvarKodePos') : CDvarKodePos, ('CDvarNegaraDomisili') : CDvarNegaraDomisili, ('CDvarPetunjukAlamat') : CDvarPetunjukAlamat
            , ('CDvarNoTlp1') : CDvarNoTlp1, ('CDvarNoTlp2') : CDvarNoTlp2, ('CDvarTinggalSejakKapan') : CDvarTinggalSejakKapan
            , ('CDvarStatusTempatTinggal') : CDvarStatusTempatTinggal, ('CDvarDomisili') : CDvarDomisili, ('CPvarPekerjaan') : CPvarPekerjaan
            ...
            , ('CPvarNoExt') : CPvarNoExt, ('CUvarPekerjaan') : CUvarPekerjaan, ('CUvarBadanUsaha') : CUvarBadanUsaha, ('CUvarNamaPerusahaan') : CUvarNamaPerusahaan
            , ('CUvarBidangUsaha') : CUvarBidangUsaha, ('CUvarSubBidangUsaha') : CUvarSubBidangUsaha, ('CUvarAlamatKantor') : CUvarAlamatKantor
            , ('CUvarRT') : CUvarRT, ('CUvarRW') : CUvarRW, ('CUvarKodePos') : CUvarKodePos, ('CUvarPetunjukAlamat') : CUvarPetunjukAlamat
            , ('CUvarTlp1') : CUvarTlp1, ('CUvarTlp2') : CUvarTlp2, ('CUvarExt') : CUvarExt, ('CUvarHP') : CUvarHP, ('CUvarWebsite') : CUvarWebsite
...
not_run: if (AllGuarantor == 'Ya') {
    ...
    WebUI.callTestCase(findTestCase('Data Entry/Guarantor/Flow Guarantor'), [('GvarPekerjaanTab') : GvarPekerjaanTab, ('GvarUsahaTab') : GvarUsahaTab
            ...
            , ('GIvarJenisKelamin') : GIvarJenisKelamin, ('GIUvarNamaLTS') : GIUvarNamaLTS, ('GIUvarNamaIbuK') : GIUvarNamaIbuK
            , ('GIUvarPendidikan') : GIUvarPendidikan, ('GIUvarEmail') : GIUvarEmail, ('GIUvarTseluler') : GIUvarTseluler
            , ('GIUvarAkunsosmed') : GIUvarAkunsosmed, ('GIUvarSosmed') : GIUvarSosmed, ('GIUvarNoNPWP') : GIUvarNoNPWP, ('GIUvarNamaNPWP') : GIUvarNamaNPWP
            , ('GIUvarKodeArea') : GIUvarKodeArea, ('GIUvarTelepon') : GIUvarTelepon, ('GDvarNegara') : GDvarNegara, ('GDvarPtjkAlamat') : GDvarPtjkAlamat
            , ('GDvarTngglSejakTahun') : GDvarTngglSejakTahun, ('GDvarStatusTT') : GDvarStatusTT, ('GDvarAlamatLengkap') : GDvarAlamatLengkap
            , ('GDvarRT') : GDvarRT, ('GDvarRW') : GDvarRW, ('GDvarKodePos') : GDvarKodePos, ('GDvarNoTlp1') : GDvarNoTlp1
            , ('GDvarNoTlp2') : GDvarNoTlp2, ('GDvarDomisili') : GDvarDomisili, ('GBvarJabatan') : GBvarJabatan, ('GBvarBadanUsaha') : GBvarBadanUsaha
            , ('GBvarBidangUsaha') : GBvarBidangUsaha, ('GBvarSubBdngUsaha') : GBvarSubBdngUsaha, ('GBvarPekerjaan') : GBvarPekerjaan
            , ('GBvarNamaPerusahaan') : GBvarNamaPerusahaan, ('GBvarNationalityPeruahaan') : GBvarNationalityPeruahaan, ('GBvarWebsite') : GBvarWebsite
            , ('GBvarJenisAkunSosmed') : GBvarJenisAkunSosmed, ('GBvarSosmed') : GBvarSosmed, ('GBvarStatusKaryawan') : GBvarStatusKaryawan
            , ('GBvarDepartemen') : GBvarDepartemen, ('GBvarAlamatKantor') : GBvarAlamatKantor, ('GBvarRT') : GBvarRT, ('GBvarRW') : GBvarRW
            , ('GBvarKodePos') : GBvarKodePos, ('GBvarPtnjkAlamat') : GBvarPtnjkAlamat, ('GBvarKodeArea') : GBvarKodeArea
            , ('GBvarTelepon') : GBvarTelepon, ('GBvarNIK') : GBvarNIK, ('GBvarEXT') : GBvarEXT, ('GUvarPekerjaan') : GUvarPekerjaan
            , ('GUvarBadanUsaha') : GUvarBadanUsaha, ('GUvarNamaUsaha') : GUvarNamaUsaha, ('GUvarBidangUsaha') : GUvarBidangUsaha
            , ('GUvarSubBidangUsaha') : GUvarSubBidangUsaha, ('GUvarAlamat') : GUvarAlamat, ('GUvarRT') : GUvarRT, ('GUvarRW') : GUvarRW
            , ('GUvarKodePos') : GUvarKodePos, ('GUvarPtnjkAlamat') : GUvarPtnjkAlamat, ('GUIvarTeleponseluler') : GUIvarTeleponseluler
            , ('GUvarWebsite') : GUvarWebsite, ('GUvarJenisSosmed') : GUvarJenisSosmed, ('GUvarSosmed') : GUvarSosmed], 
        FailureHandling.STOP_ON_FAILURE)
}
...
not_run: WebUI.callTestCase(findTestCase('Data Entry/Data Asset/MASTER FLOW/TC_Data Asset - MASTER FLOW'), [('varNomorRangka') : varNomorRangka
        ...
        , ('Survey_varTeleponSeluler') : '08377373', ('Survey_varvarPetunjukAlamat') : 'ahahhahahahah', ('Survey_varAlamatSurveySamaDomisili') : Survey_varAlamatSurveySamaDomisili
...
not_run: WebUI.callTestCase(findTestCase('Data Entry/Summary Outstanding/MASTER FLOW/TC_Summary Outstanding - MASTER FLOW'), 
    [:], FailureHandling.STOP_ON_FAILURE)

not_run: com.kms.katalon.core.appium.driver.AppiumDriverManager.getDriver().quit()
